...
$string['security:insecure_internal_http_warning'] = 'Internal connector HTTP security verification is temporarily disabled by local config. Use this only for local development with trusted endpoints.';
...
$string['adminaccess:page_title'] = 'Moodlepilot admin access';
$string['adminaccess:page_heading'] = 'Temporary admin access';
$string['adminaccess:return_home'] = 'Return to site home';
$string['adminaccess:error_post_required'] = 'Open temporary admin access from the Moodlepilot dashboard. Direct GET links are not used for redemption.';
$string['adminaccess:error_missing_token'] = 'This admin access link is missing its token.';
$string['adminaccess:error_unavailable'] = 'Temporary admin access is not available yet for this tenant. Please sync the Moodlepilot plugin first.';
$string['adminaccess:error_user_not_found'] = 'The platform admin account could not be found on this Moodle site.';
$string['adminaccess:error_ambiguous_email'] = 'The admin access link could not be matched safely because the target email belongs to more than one account.';
$string['adminaccess:success_notice'] = 'Temporary admin access is active for this session. Change the password now if you no longer remember it.';
