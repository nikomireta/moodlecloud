...
$string['dashboard:page_title'] = 'Moodlepilot reports';
$string['dashboard:page_heading'] = 'Moodlepilot reporting workspace';
$string['dashboard:page_intro'] = 'This page exposes the first local report surfaces inside Moodle while the tenant also syncs summary and drilldown datasets to Moodlepilot.';
...
$string['dashboard:section_recent_activity'] = 'Recent activity preview';
$string['dashboard:empty'] = 'No data available for the current 7-day reporting window.';
